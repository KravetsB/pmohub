...
export const Login = () => {
  ...
  const handleChangePassword = (e: React.FormEvent) => {
    ...
    const user = users.find(
      (u) => u.email.toLowerCase() === cpEmail.toLowerCase(),
    );
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 w-full max-w-md my-8">
        ...
        <form onSubmit={handleEmailLogin} className="space-y-4 mb-6">
          ...
          <button
            type="submit"
            className="w-full bg-indigo-500 hover:bg-indigo-600 text-white font-bold py-2 rounded-lg transition-colors mt-2"
          >
            Увійти
          </button>
        </form>
        ...
        <div className="relative mb-8">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-white text-slate-500">
              швидкий вибір тестового користувача
            </span>
          </div>
        </div>
        ...
        <div className="fixed inset-0 bg-slate-900/50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl w-full max-w-md p-6 relative shadow-2xl">
            ...
            <form onSubmit={handleChangePassword} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full border border-slate-300 rounded-lg px-3 py-2 pr-10 outline-none focus:ring-2 focus:ring-indigo-500"
                  />
                  <button
                    type="button"
              ...
              {cpSuccess && (
                <div className="text-emerald-600 text-sm font-medium bg-emerald-50 p-2 rounded-lg">
                  {cpSuccess}
                </div>
              )}
              ...
              <div className="flex justify-end gap-2 mt-6">
                ...
                <button
                  type="submit"
                  className="px-4 py-2 rounded-lg font-bold bg-indigo-500 text-white hover:bg-indigo-600"
                >
                  Змінити пароль
                </button>
              </div>
